; (function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)', 'JANGAN LUPA',
     'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH',
     'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI',
     'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESAL',
     'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 
     'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU',
      'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YASUDAH DEH', 'I', 'LOVE', 'YOU ♡',
       'AKU SAYANG HANA', 'EHE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU SEDIKIT KESAL']
